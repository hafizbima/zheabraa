-- ============================================================
-- Zheabraa — FULL SETUP SQL (schema + semua migration)
...
-- ============================================================
-- Gimme Money â€” Supabase schema (PostgreSQL + RLS + Realtime)
-- Jalankan sekali di: Supabase Dashboard > SQL Editor
...
-- ########## migration-recurring-income.sql ##########
...
-- ########## migration-recurring-transfer.sql ##########
